      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 luxury-shadow border border-gray-50">
          ...
          <div className="mt-8 pt-6 border-t border-gray-50 text-center space-y-4">
            <Link to="/forgot-password" className="text-sm text-gray-400 hover:text-primary transition-colors block">
              Esqueceu sua senha?
            </Link>
            <Link to="/register" className="text-sm text-gray-400 hover:text-primary transition-colors block">
